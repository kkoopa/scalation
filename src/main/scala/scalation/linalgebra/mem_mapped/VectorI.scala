...
import scalation.util.{Error, MM_ArrayI}
import scalation.util.MM_SortingI.{iqsort, qsort2}
      ...
      extends Traversable [Int] with PartiallyOrdered [VectorI] with Vec with Error with Serializable
{
     ...
     */
    def this (u: MM_ArrayI) { this (u.length, u) }
    ...
    def expand (more: Int = dim): VectorI =
    {
        ...
        else          new VectorI (dim + more, MM_ArrayI.concat (v, new MM_ArrayI (more)))
    } // expand
     ...
     */
    def setAll (u: MM_ArrayI) { for (i <- range) v(i) = u(i) }
     ...
     *  @param p  the predicate (Boolean function) to apply
     */
    def filterPos (p: Int => Boolean): Array [Int] =
    {
     ...
     *  @param f  the function to apply
     */
    def map (f: Int => Int): VectorI = new VectorI (v.map (f))
     ...
     */
    def sum: Int = v.foldLeft (0)((s: Int, x: Int) => s + x)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Sum the absolute value of the elements of 'this' vector.
     */
    def sumAbs: Int = v.foldLeft (0)((s, x) => s + ABS (x))

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Sum the elements of 'this' vector skipping the 'i'-th element (Not Equal 'i').
     *  @param i  the index of the element to skip
     */
    def sumNE (i: Int): Int = sum - v(i)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Sum the positive (> 0) elements of 'this' vector.
     */
    def sumPos: Int = v.foldLeft (0)((s, x) => s + MAX (x, 0))
     ...
     */
    def variance = (normSq - sum * sum / nd) / (nd-1)
   ...
   //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    {
        var count = 1
        val us = new VectorI (this); us.sort2 ()               // sorted vector
 ...
 *  > run-main scalation.linalgebra.mem_mapped.VectorITest
 */
